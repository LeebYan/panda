...
/**
 * @program: pigx
 * @description: 实现 一个设备登陆
 * @author: Sinda
 * @create: 2020/9/29 4:53 下午
 */
public class PigxDefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
