...
public class MsgHandler extends AbstractHandler {
	...
	public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage,
		...
		if (!wxMessage.getMsgType().equals(XmlMsgType.EVENT)) {
			...
			WxAccountFans fans = wxAccountFansMapper.selectOne(Wrappers.<WxAccountFans>lambdaQuery()
	 ...
	 * @return
	 */
	public static WxMpXmlOutMessage getWxMpXmlOutMessage(WxMpXmlMessage wxMessage
			, List<WxAutoReply> listWxAutoReply, WxAccountFans fans, WxMsgMapper wxMsgMapper, WxAccount wxAccount) {
