package com.pig4cloud.pigx.common.poi.excel.imports.base;
...
import com.pig4cloud.pigx.common.core.util.ApplicationContextUtil;
import com.pig4cloud.pigx.common.dict.service.AutoPoiDictServiceI;
import org.apache.commons.lang3.StringUtils;
import org.apache.poi.ss.usermodel.Workbook;
import com.pig4cloud.pigx.common.poi.excel.annotation.Excel;
import com.pig4cloud.pigx.common.poi.excel.annotation.ExcelCollection;
import com.pig4cloud.pigx.common.poi.excel.annotation.ExcelVerify;
import com.pig4cloud.pigx.common.poi.excel.entity.ImportParams;
import com.pig4cloud.pigx.common.poi.excel.entity.params.ExcelCollectionParams;
import com.pig4cloud.pigx.common.poi.excel.entity.params.ExcelImportEntity;
...
public class ImportBaseService {
	...
	public void addEntityToMap(String targetId, Field field, ExcelImportEntity excelEntity, Class<?> pojoClass, List<Method> getMethods, Map<String, ExcelImportEntity> temp) throws Exception {
		...
		if(StringUtils.isNotEmpty(excel.dicCode())){
			AutoPoiDictServiceI bossDictService = null;
			try {
				bossDictService = ApplicationContextUtil.getContext().getBean(AutoPoiDictServiceI.class);
			} catch (Exception e) {
			}
			if(bossDictService!=null){
				 String[] dictReplace = bossDictService.queryDict(excel.dictTable(), excel.dicCode(), excel.dicText());
	...
	public String getExcelName(String exportName, String targetId) {
		...
		String[] arr = exportName.split(StringPool.COMMA);
		for (String str : arr) {
