...
public class MyXWPFDocument extends XWPFDocument {
	...
	private static String PICXML = ""
			...
			+ "         <pic:nvPicPr>" + "            <pic:cNvPr id=\"%s\" name=\"Generated\"/>" + "            <pic:cNvPicPr/>" + "         </pic:nvPicPr>" + "         <pic:blipFill>" + "            <a:blip r:embed=\"%s\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\"/>" + "            <a:stretch>" + "               <a:fillRect/>" + "            </a:stretch>" + "         </pic:blipFill>" + "         <pic:spPr>" + "            <a:xfrm>"
			+ "               <a:off x=\"0\" y=\"0\"/>"
			+ "               <a:ext cx=\"%s\" cy=\"%s\"/>" + "            </a:xfrm>"
	...
	public void createPicture(String blipId, int id, int width, int height) {
		...
		try {
			...
			log.error(xe.getMessage(), xe.fillInStackTrace());
		}
		inline.set(xmlToken);
