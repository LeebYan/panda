...
INSERT INTO `config_info` VALUES (13, 'pigx-bi-platform-dev.yml', 'DEFAULT_GROUP', '# ureport 报表相关设置\nureport:\n  debug: false\n  disableFileProvider: true\n  disableHttpSessionReportCache: true\n\n# oss 保存报表设计文件\noss:\n  bucket-name: lengleng\n  access-key: lengleng\n  secret-key: lengleng\n  endpoint: http://minio.pig4cloud.com', '5a1d88393a927bb3753536610dc265ad', '2020-10-15 18:18:13', '2020-10-15 18:18:13', NULL, '172.16.1.198', '', '', NULL, NULL, NULL, 'yaml', NULL);
COMMIT;
