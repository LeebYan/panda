...
CREATE TABLE `xxl_job_info` (
  ...
  `glue_source` mediumtext CHARACTER SET utf8 COMMENT 'GLUE源代码',
...
CREATE TABLE `xxl_job_log` (
  ...
  `trigger_msg` mediumtext,
  `handle_time` datetime DEFAULT NULL COMMENT '执行-时间',
  `handle_code` int(11) NOT NULL COMMENT '执行-状态',
  `handle_msg` mediumtext,
...
CREATE TABLE `xxl_job_registry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `registry_group` varchar(255) DEFAULT NULL,
  `registry_key` varchar(255) DEFAULT NULL,
  `registry_value` varchar(255) DEFAULT NULL,
